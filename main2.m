...
P_train1=trainP_padded';
P_train2=trainPosmerge_padded';
P_train3=trainN_padded';
...
P_test1=testPos_padded';
P_test2=testNeg_padded';
P_test3=testAnother_padded';
...
P_train =  double(reshape(P_train, 3760, 1, 1, M));
P_test  =  double(reshape(P_test , 3760, 1, 1, N));
...
layers = [ ...
  ...
  lstmLayer(9, 'OutputMode', 'last')   % LSTM层,6修改为9
  reluLayer                            % Relu激活层
